  ...
  en: {
    translation: {
      ...
      "hero": {
        ...
        "subtitle": "Discover, play, and distribute the next generation of indie hits and blockbuster titles. Welcome to The Arcade.",
        "start": "Start Playing",
  ...
  es: {
    translation: {
      ...
      "hero": {
        ...
        "subtitle": "Descubre, juega y distribuye la próxima generación de éxitos independientes. Bienvenido a The Arcade.",
  ...
  fr: {
    translation: {
      ...
      "hero": {
        ...
        "subtitle": "Découvrez, jouez et distribuez la prochaine génération de succès. Bienvenue dans The Arcade.",
  ...
  pt: {
    translation: {
      ...
      "hero": {
        ...
        "subtitle": "Descubra, jogue e distribua a próxima geração de sucessos. Bem-vindo ao The Arcade.",
  ...
  it: {
    translation: {
      ...
      "hero": {
        ...
        "subtitle": "Scopri, gioca e distribuisci la prossima generazione di successi. Benvenuto in The Arcade.",
