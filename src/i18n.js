  ...
  en: {
    translation: {
      ...
      "hero": {
        ...
        "subtitle": "Discover, play, and distribute the next generation of indie hits and blockbuster titles. Welcome to NexGames.",
        "start": "Start Playing",
  ...
  es: {
    translation: {
      ...
      "hero": {
        ...
        "subtitle": "Descubre, juega y distribuye la próxima generación de éxitos independientes. Bienvenido a NexGames.",
  ...
  fr: {
    translation: {
      ...
      "hero": {
        ...
        "subtitle": "Découvrez, jouez et distribuez la prochaine génération de succès. Bienvenue dans NexGames.",
  ...
  pt: {
    translation: {
      ...
      "hero": {
        ...
        "subtitle": "Descubra, jogue e distribua a próxima geração de sucessos. Bem-vindo ao NexGames.",
  ...
  it: {
    translation: {
      ...
      "hero": {
        ...
        "subtitle": "Scopri, gioca e distribuisci la prossima generazione di successi. Benvenuto in NexGames.",
